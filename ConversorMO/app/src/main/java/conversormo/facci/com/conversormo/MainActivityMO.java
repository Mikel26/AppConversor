package conversormo.facci.com.conversormo;
...
public class MainActivityMO extends AppCompatActivity {
    ...
    public void clickConvertir(View v){
        ...
        if (resultado >0){
            ...
            editor.putString("monedaCmabio",monedaCambio);

            editor.commit();

        }else {
            resultadoTV.setText(String.format("Usted recibirá"));
            Toast.makeText(MainActivityMO.this,"Las opciones elegidas no tienen un factor de conversión",Toast.LENGTH_SHORT).show();
        }
    }
